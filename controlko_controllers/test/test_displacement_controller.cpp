...
TEST_F(DisplacementControllerTest, activate_success)
{
  SetUpController();
...
TEST_F(DisplacementControllerTest, update_success)
{
  SetUpController();
...
TEST_F(DisplacementControllerTest, deactivate_success)
{
  SetUpController();
...
TEST_F(DisplacementControllerTest, reactivate_success)
{
  SetUpController();
...
TEST_F(DisplacementControllerTest, test_setting_slow_mode_service)
{
  SetUpController();
...
TEST_F(DisplacementControllerTest, test_update_logic_fast)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(DisplacementControllerTest, test_update_logic_slow)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(DisplacementControllerTest, publish_status_success)
{
  SetUpController();
...
TEST_F(DisplacementControllerTest, receive_message_and_publish_updated_status)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
