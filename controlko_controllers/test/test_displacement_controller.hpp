...
#ifndef TEMPLATES__ROS2_CONTROL__CONTROLLER__TEST_DISPLACEMENT_CONTROLLER_HPP_
#define TEMPLATES__ROS2_CONTROL__CONTROLLER__TEST_DISPLACEMENT_CONTROLLER_HPP_
...
class TestableDisplacementController : public controlko_controllers::DisplacementController
{
  FRIEND_TEST(DisplacementControllerTest, all_parameters_set_configure_success);
  FRIEND_TEST(DisplacementControllerTest, activate_success);
  FRIEND_TEST(DisplacementControllerTest, reactivate_success);
  FRIEND_TEST(DisplacementControllerTest, test_setting_slow_mode_service);
  FRIEND_TEST(DisplacementControllerTest, test_update_logic_fast);
  FRIEND_TEST(DisplacementControllerTest, test_update_logic_slow);
...
class DisplacementControllerFixture : public ::testing::Test
{
public:
  ...
  void SetUp()
  {
    ...
    command_publisher_ = command_publisher_node_->create_publisher<ControllerReferenceMsg>(
      "/test_displacement_controller/commands", rclcpp::SystemDefaultsQoS());
    ...
    slow_control_service_client_ = service_caller_node_->create_client<ControllerModeSrvType>(
      "/test_displacement_controller/set_slow_control_mode");
  }
...
protected:
  void SetUpController(const std::string controller_name = "test_displacement_controller")
  {
  ...
  void subscribe_and_get_messages(ControllerStateMsg & msg)
  {
    ...
    auto subscription = test_subscription_node.create_subscription<ControllerStateMsg>(
      "/test_displacement_controller/state", 10, subs_callback);
...
#endif  // TEMPLATES__ROS2_CONTROL__CONTROLLER__TEST_DISPLACEMENT_CONTROLLER_HPP_
